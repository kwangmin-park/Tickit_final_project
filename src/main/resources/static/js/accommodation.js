$(document).ready(function () { //렌더링 완료 후 실행
    ...
    const showTickets = function (item) {
        ...
        //debugger;
        //티켓 템플릿 //TODO 이름 바꾸기
        $('.empty-ticket-body-accommodation').before(`<!--숙소 티켓 템플릿-->
                ...
                <div class="ticket-main col-8 ">
                    ...
                    <div class="ticket-header ticket-main-header ">
                        <div class="header-title">
                            <i class="fas fa-bed"></i>  Accommodation voucher
                        </div>
                    ...
                    <div class="ticket-content">
                        <h2 class="ticket-date"><input type="text" class="ticketDate" required value="${item.ticketDate}"></h2>
                        <div class="ticket-main-content">
                            <h5><input type="text" class="ticketNickname "  value="${item.ticketNickname}"></h5>
                            <div class="line-decor"></div>
                                <div class="row">
                                    <div class="col">
                                        <span class="emp-word">CHECK-IN</span>
                                        <br>
                                        <span class="ticket-mini-date"><input type="text" class="departDate width-accom"  value="${item.departDate}"></span>
                                        <br>
                                        <h6 class="width-accom"><input type="text" class="departTime width-accom"  value="${item.departTime}"></h6>
                                    </div>
                                    <div class="col">
                                        <span class="emp-word">CHECK-OUT</span>
                                        <br>
                                        <span ><input type="text" class="arriveDate width-accom"  value="${item.arriveDate}"></span>
                                        <br>
                                        <h6> <input type="text" class="arriveTime width-accom"  value="${item.arriveTime}"></h6>
                                    </div>
                                </div>

                        </div>
                        <div class="ticket-price-container"><input type="text" class="ticketPrice ticket-price width-small"  value="${item.ticketPrice}" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"></div>
    ...
    //티켓 추가
    $('.empty-plus-btn-accomodation').click(function () {
        transTicketRegister();
    });
