$(document).ready(function () { //렌더링 완료 후 실행
                ...
                <div class="ticket-main col-8 ">
                    ...
                    <div class="ticket-header ticket-main-header ">
                        <div class="header-title">
                           <i class="fas fa-compass"></i>  Where to go
                        </div>
    ...
    //티켓 추가
    $('.empty-plus-btn-tour').click(function () {
        debugger;
        transTicketRegister();
    });
